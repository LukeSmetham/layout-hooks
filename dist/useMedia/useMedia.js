...
var _default = function _default(breakpoint) {
  ...
  var breakpoints = (0, _react.useContext)(_BreakpointContext["default"]); // eslint-disable-next-line no-undef

  var query = window.matchMedia("(".concat(minmax, "-width: ").concat(breakpoints[breakpoint], "px)"));
